...
public class Usuario implements Serializable {
    ...
    private int id;                                     //Cada vez que se agregue un usuario nuevo, 
                                                        //se hara de forma automatica la Id.
    ...
    public Usuario(int id, String apellidoUsuario, String nombreUsuario,
            String dni, Rol unRol, List<FechaHora> fechasHora) {
        this.id = id;
