...
public class Controladora {
    ...
    public Usuario validarUsuario(String usuario, String dni) {
        ...
        for (Usuario usu : listaUsuarios) {
            ...
            if (usu.getNombreUsuario().equals(usuario)) { //usamos "equals" porque comparamos cadenas de caracteres                
    ...
    public Usuario validarDni(String dni) {
        ...
        for (Usuario usu : listaUsuarios) {
            ...
            if (usu.getDni().equals(dni)) { //usamos "equals" porque comparamos cadenas de caracteres                
    ...
    public void crearUsuario(String apellido,String usuario, String dniNuevo, String rolRecibido) {
    ...
    public void editarUsuario(Usuario usu, String apellido,String usuario, String dniNuevo, String rolRecibido) {
    ...
    public void crearHoraEntrada(int horaEntrada) {
        
        FechaHora fecHor = new FechaHora ();
        fecHor.setHoraEntrada(horaEntrada);
