...
public class FechaHoraJpaController implements Serializable {
    ...
    public void create(FechaHora fechaHora) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findFechaHora(fechaHora.getId()) != null) {
                throw new PreexistingEntityException("FechaHora " + fechaHora + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
